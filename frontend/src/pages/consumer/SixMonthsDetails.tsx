              ...
              <div className="divide-y divide-white/5">
                {monthlyData.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-20 text-center">
                    <p className="text-white/60 text-lg font-medium">No bills generated yet</p>
                    <p className="text-white/40 text-sm mt-2">Your bills will appear here once generated by the system.</p>
                  </div>
                ) : (
